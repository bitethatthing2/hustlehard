...
const InstallAppPromo = () => {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8 bg-black/30 border border-bar-accent/20 rounded-xl backdrop-blur-sm">
      <div className="text-center">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link href="/instructions/ios">
            <Button className="bg-bar-accent text-black hover:bg-bar-accent/80 px-6 py-2 h-auto">
