  ...
  return (
    <section className="w-full bg-black relative">
      ...
      {showScrollTop && (
        <button 
          onClick={scrollToTop}
          className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white text-black px-4 py-2 rounded-md shadow-lg hover:bg-gray-100 transition-all flex items-center gap-2 font-bold text-sm"
