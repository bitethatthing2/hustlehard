    ...
    <section className={`w-full ${isDark ? 'bg-gray-950/90' : 'bg-white'} relative`}>
      ...
      <div className="container mx-auto py-12 px-8">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-10 lg:gap-16">
          ...
          {/* App installation and notifications */}
          <div className="w-full max-w-md mt-6 flex flex-col gap-3">
            <Button 
              className={`h-16 text-lg font-semibold w-full ${isDark ? 'bg-white text-black hover:bg-gray-200' : 'bg-black text-white hover:bg-black/90'}`}
              onClick={() => {
