    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div className="lg:col-span-2">
          <div className="bg-bar-muted/30 border border-bar-accent/20 rounded-xl p-6 mb-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-bar-muted/30 border border-bar-accent/20 rounded-xl p-6 sticky top-4">
            <div className="mb-6">
            ...
            {event.ticketLink && (
              <a
                ...
                className="w-full inline-flex items-center justify-center px-6 py-3 bg-bar-accent text-black rounded-lg font-bold hover:bg-bar-accent/90 transition-colors mb-4"
              >
                Get Tickets
      ...
      {relatedEvents.length > 0 && (
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6">More Events</h2>
